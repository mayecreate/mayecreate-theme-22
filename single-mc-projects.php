...
if($projects_options) { ?>
    <?php $single_page_content_width = $projects_options['single_page_content_width']; ?>
    <?php $single_page_show_a_featured_image = $projects_options['single_page_show_a_featured_image']; ?>
    <?php $single_page_featured_image_alignment = $projects_options['single_page_featured_image_alignment']; ?>
    <?php $single_page_show_post_date = $projects_options['single_page_show_post_date']; ?>
